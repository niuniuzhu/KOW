...
define("UI/UIMain", ["require", "exports", "Scene/SceneManager"], function (require, exports, SceneManager_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class UIMain {
...
define("UI/UIMatching", ["require", "exports", "../Libs/protos", "UI/UIAlert", "Scene/SceneManager"], function (require, exports, protos_6, UIAlert_2, SceneManager_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class UIMatching {
        get root() { return this._root; }
        ...
        OnLoginBSResut(result) {
            switch (result) {
                case protos_6.Protos.BS2GC_LoginRet.EResult.Success:
                    break;
                default:
            ...
            if (enterBattle.error != protos_7.Protos.CS2GC_EnterBattle.Error.Success) {
                ...
                connector.onopen = () => {
                    ...
                    connector.Send(protos_7.Protos.GC2BS_AskLogin, askLogin, message => {
                        ...
                        switch (resp.result) {
                            case protos_7.Protos.BS2GC_LoginRet.EResult.Success:
                                SceneManager_5.SceneManager.ChangeState(SceneManager_5.SceneManager.State.Battle);
                                break;
                        }
                    });
                };
...
define("Scene/BattleState", ["require", "exports", "Scene/SceneState", "Net/Connector", "../Libs/protos", "RC/Utils/Logger", "Scene/SceneManager", "UI/UIManager"], function (require, exports, SceneState_5, Connector_4, protos_8, Logger_5, SceneManager_6, UIManager_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("Preloader", ["require", "exports", "RC/Utils/Logger", "Model/Defs"], function (require, exports, Logger_6, Defs_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Preloader {
