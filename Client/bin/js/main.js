...
define("Defs", ["require", "exports", "RC/Utils/Hashtable"], function (require, exports, Hashtable_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Defs {
...
define("Graphic", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Graphic {
...
define("UI/UIAlert", ["require", "exports", "Graphic"], function (require, exports, Graphic_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class UIAlert {
...
define("UI/UIMain", ["require", "exports", "Scene/SceneManager", "Graphic"], function (require, exports, SceneManager_1, Graphic_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class UIMain {
        ...
        constructor() {
            ...
            this._root.setSize(Graphic_2.Graphic.uiRoot.width, Graphic_2.Graphic.uiRoot.height);
            this._root.addRelation(Graphic_2.Graphic.uiRoot, fairygui.RelationType.Size);
        ...
        Enter(param) {
            Graphic_2.Graphic.uiRoot.addChild(this._root);
        ...
        Exit() {
            Graphic_2.Graphic.uiRoot.removeChild(this._root);
        }
        Update(dt) {
        }
        OnResize(e) {
...
define("Scene/MainState", ["require", "exports", "Scene/SceneState", "UI/UIManager"], function (require, exports, SceneState_1, UIManager_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("Scene/LoginState", ["require", "exports", "../Libs/protos", "Net/Connector", "Net/ProtoHelper", "Net/WSConnector", "UI/UIManager", "Scene/SceneState", "Scene/SceneManager", "Defs", "RC/Utils/Logger"], function (require, exports, protos_4, Connector_1, ProtoHelper_3, WSConnector_2, UIManager_2, SceneState_2, SceneManager_2, Defs_1, Logger_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class LoginState extends SceneState_2.SceneState {
        constructor(type) {
            super(type);
            this.__ui = this._ui = UIManager_2.UIManager.login;
        }
                    ...
                    switch (resp.result) {
                        case protos_4.Protos.GS2GC_LoginRet.EResult.Success:
                            if (resp.gcState == protos_4.Protos.GS2GC_LoginRet.EGCCState.Battle) {
                                ...
                                SceneManager_2.SceneManager.ChangeState(SceneManager_2.SceneManager.State.Main);
                            }
                            break;
                    }
                });
...
define("Scene/GlobalState", ["require", "exports", "Scene/SceneState", "Net/Connector", "UI/UIAlert", "../Libs/protos", "Scene/SceneManager", "RC/Utils/Logger"], function (require, exports, SceneState_3, Connector_2, UIAlert_1, protos_5, SceneManager_3, Logger_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class GlobalState extends SceneState_3.SceneState {
        constructor(type) {
            super(type);
            Connector_2.Connector.gsConnector.onclose = this.HandleGSDisconnect;
            Connector_2.Connector.AddListener(Connector_2.Connector.ConnectorType.GS, protos_5.Protos.MsgID.eGS2GC_Kick, this.HandleKick);
        }
        HandleGSDisconnect(e) {
            Logger_3.Logger.Log("gs connection closed.");
            UIAlert_1.UIAlert.Show("与服务器断开连接", () => SceneManager_3.SceneManager.ChangeState(SceneManager_3.SceneManager.State.Login, null, true), true);
        }
        HandleKick(message) {
            Logger_3.Logger.Log("kick by server");
            let kick = message;
            switch (kick.reason) {
                case protos_5.Protos.CS2GS_KickGC.EReason.DuplicateLogin:
                    UIAlert_1.UIAlert.Show("另一台设备正在登陆相同的账号", () => SceneManager_3.SceneManager.ChangeState(SceneManager_3.SceneManager.State.Login, null, true), true);
                    break;
                default:
                    UIAlert_1.UIAlert.Show("已被服务器强制下线", () => SceneManager_3.SceneManager.ChangeState(SceneManager_3.SceneManager.State.Login, null, true), true);
                    break;
            }
        }
    }
...
define("UI/UIMatching", ["require", "exports", "../Libs/protos", "UI/UIAlert", "Scene/SceneManager", "Graphic"], function (require, exports, protos_6, UIAlert_2, SceneManager_4, Graphic_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class UIMatching {
        get root() { return this._root; }
        constructor() {
            ...
            this._root.setSize(Graphic_3.Graphic.uiRoot.width, Graphic_3.Graphic.uiRoot.height);
            this._root.addRelation(Graphic_3.Graphic.uiRoot, fairygui.RelationType.Size);
        }
        Dispose() {
        }
        Enter(param) {
            Graphic_3.Graphic.uiRoot.addChild(this._root);
        }
        Exit() {
            Graphic_3.Graphic.uiRoot.removeChild(this._root);
        }
        Update(dt) {
        }
        OnResize(e) {
        ...
        OnConnectToBSError() {
            UIAlert_2.UIAlert.Show("无法连接服务器", () => SceneManager_4.SceneManager.ChangeState(SceneManager_4.SceneManager.State.Matching, null, true));
        }
        OnBeginMatchResult(result) {
            ...
            switch (result) {
                case protos_6.Protos.CS2GC_BeginMatchRet.EResult.Success:
                    break;
                case protos_6.Protos.CS2GC_BeginMatchRet.EResult.IllegalID:
                    error = "无效网络ID";
                    break;
                case protos_6.Protos.CS2GC_BeginMatchRet.EResult.NoRoom:
                    error = "匹配失败";
                    break;
                case protos_6.Protos.CS2GC_BeginMatchRet.EResult.UserInBattle:
                    error = "玩家已在战场中";
                    break;
                case protos_6.Protos.CS2GC_BeginMatchRet.EResult.UserInRoom:
                    error = "玩家已在匹配中";
                    break;
                case protos_6.Protos.CS2GC_BeginMatchRet.EResult.Failed:
                    error = "匹配失败";
                    break;
            }
            if (error != "") {
                UIAlert_2.UIAlert.Show(error, () => SceneManager_4.SceneManager.ChangeState(SceneManager_4.SceneManager.State.Matching, null, true));
            }
        }
        OnEnterBattleResult(result) {
            switch (result) {
                case protos_6.Protos.CS2GC_EnterBattle.Error.Success:
                    break;
        ...
        OnLoginBSResut(result) {
            switch (result) {
                case protos_6.Protos.Global.ECommon.Success:
                    break;
                default:
                    UIAlert_2.UIAlert.Show("进入战场失败", () => SceneManager_4.SceneManager.ChangeState(SceneManager_4.SceneManager.State.Matching, null, true));
                    break;
            }
        }
...
define("Scene/PreloadInstance", ["require", "exports", "Consts"], function (require, exports, Consts_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class PreloadInstance {
        ...
        static LoadAssets(mapID, playerInfos, completeHandler) {
            ...
            const assetMapID = Consts_1.Consts.ASSETS_MAP_PREFIX + mapID;
            ...
            for (let i = 0; i < count; i++) {
                ...
                const assetEntityID = Consts_1.Consts.ASSETS_ENTITY_PREFIX + playerInfo.actorID;
...
define("Scene/MatchingState", ["require", "exports", "UI/UIManager", "Net/Connector", "../Libs/protos", "Net/ProtoHelper", "Scene/SceneState", "RC/Utils/Logger", "Scene/SceneManager", "Scene/PreloadInstance"], function (require, exports, UIManager_3, Connector_3, protos_7, ProtoHelper_4, SceneState_4, Logger_4, SceneManager_5, PreloadInstance_1) {
    ...
    class MatchingState extends SceneState_4.SceneState {
        constructor(type) {
            super(type);
            this.__ui = this._ui = UIManager_3.UIManager.matching;
        }
        OnEnter(param) {
            super.OnEnter(param);
            this._roomID = 0;
            ...
            this._maxPlayers = 0;
            this._players = [];
            Connector_3.Connector.AddListener(Connector_3.Connector.ConnectorType.GS, protos_7.Protos.MsgID.eCS2GC_RoomInfo, this.OnUpdateRoomInfo.bind(this));
            Connector_3.Connector.AddListener(Connector_3.Connector.ConnectorType.GS, protos_7.Protos.MsgID.eCS2GC_PlayerJoin, this.OnPlayerJoint.bind(this));
            Connector_3.Connector.AddListener(Connector_3.Connector.ConnectorType.GS, protos_7.Protos.MsgID.eCS2GC_PlayerLeave, this.OnPlayerLeave.bind(this));
            Connector_3.Connector.AddListener(Connector_3.Connector.ConnectorType.GS, protos_7.Protos.MsgID.eCS2GC_EnterBattle, this.OnEnterBattle.bind(this));
            this.BeginMatch();
        }
        OnExit() {
            Connector_3.Connector.RemoveListener(Connector_3.Connector.ConnectorType.GS, protos_7.Protos.MsgID.eCS2GC_RoomInfo, this.OnUpdateRoomInfo.bind(this));
            Connector_3.Connector.RemoveListener(Connector_3.Connector.ConnectorType.GS, protos_7.Protos.MsgID.eCS2GC_PlayerJoin, this.OnPlayerJoint.bind(this));
            Connector_3.Connector.RemoveListener(Connector_3.Connector.ConnectorType.GS, protos_7.Protos.MsgID.eCS2GC_PlayerLeave, this.OnPlayerLeave.bind(this));
            Connector_3.Connector.RemoveListener(Connector_3.Connector.ConnectorType.GS, protos_7.Protos.MsgID.eCS2GC_EnterBattle, this.OnEnterBattle.bind(this));
            super.OnExit();
        }
        OnUpdate(dt) {
        }
        ...
        OnEnterBattle(message) {
            ...
            if (enterBattle.error != protos_7.Protos.CS2GC_EnterBattle.Error.Success) {
                this._ui.OnEnterBattleResult(enterBattle.error);
            }
            else {
                let connector = Connector_3.Connector.bsConnector;
                connector.onerror = () => this._ui.OnConnectToBSError();
                connector.onopen = () => {
                    Logger_4.Logger.Log("BS Connected");
                    let askLogin = ProtoHelper_4.ProtoCreator.Q_GC2BS_AskLogin();
                    askLogin.sessionID = enterBattle.gcNID;
                    connector.Send(protos_7.Protos.GC2BS_AskLogin, askLogin, message => {
                        let resp = message;
                        this._ui.OnLoginBSResut(resp.result);
                        switch (resp.result) {
                            case protos_7.Protos.Global.ECommon.Success:
                                SceneManager_5.SceneManager.ChangeState(SceneManager_5.SceneManager.State.Battle, resp);
                                break;
                        }
                    });
                };
        ...
        BeginMatch() {
            ...
            Connector_3.Connector.SendToCS(protos_7.Protos.GC2CS_BeginMatch, beginMatch, message => {
                let resp = message;
                this._ui.OnBeginMatchResult(resp.result);
                switch (resp.result) {
                    case protos_7.Protos.CS2GC_BeginMatchRet.EResult.Success:
                        ...
                        this._ui.UpdatePlayers(this._players);
                        Logger_4.Logger.Log("begin match");
                        break;
                }
            });
        }
...
define("UI/UIBattle", ["require", "exports", "UI/GestureState", "UI/Joystick", "Graphic"], function (require, exports, GestureState_1, Joystick_1, Graphic_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class UIBattle {
        constructor() {
            ...
            this._root.setSize(Graphic_4.Graphic.uiRoot.width, Graphic_4.Graphic.uiRoot.height);
            this._root.addRelation(Graphic_4.Graphic.uiRoot, fairygui.RelationType.Size);
        ...
        Enter(param) {
            Graphic_4.Graphic.uiRoot.addChild(this._root);
        }
        Exit() {
            Graphic_4.Graphic.uiRoot.removeChild(this._root);
        }
        Update(dt) {
...
define("Model/View/VBattle", ["require", "exports", "Graphic", "Scene/PreloadInstance", "Consts"], function (require, exports, Graphic_5, PreloadInstance_2, Consts_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class VBattle {
        Init(loginRet) {
            Graphic_5.Graphic.battleRoot.addChild(PreloadInstance_2.PreloadInstance.instances.get(Consts_2.Consts.ASSETS_MAP_PREFIX + loginRet.mapID));
        }
    }
    exports.VBattle = VBattle;
});
define("Model/Logic/Battle", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Battle {
        Init(loginRet) {
...
define("Model/BattleManager", ["require", "exports", "Model/View/VBattle", "Model/Logic/Battle", "../Libs/protos", "Net/Connector", "RC/Utils/Logger", "Scene/SceneManager", "Net/ProtoHelper"], function (require, exports, VBattle_1, Battle_1, protos_8, Connector_4, Logger_5, SceneManager_6, ProtoHelper_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class BattleManager {
        constructor() {
        ...
        Init(loginRet) {
            Connector_4.Connector.AddListener(Connector_4.Connector.ConnectorType.BS, protos_8.Protos.MsgID.eBS2GC_BattleEnd, this.OnBattleEnd.bind(this));
            this._vBattle.Init(loginRet);
            this._lBattle.Init(loginRet);
            this.RequestSnapshot();
            Logger_5.Logger.Log("battle start");
        }
        Clear() {
            Connector_4.Connector.RemoveListener(Connector_4.Connector.ConnectorType.BS, protos_8.Protos.MsgID.eBS2GC_BattleEnd, this.OnBattleEnd.bind(this));
        }
        Update(dt) {
        }
        OnBattleEnd(message) {
            let battleEnd = message;
            Logger_5.Logger.Log("battle end");
            SceneManager_6.SceneManager.ChangeState(SceneManager_6.SceneManager.State.Main);
        }
        RequestSnapshot() {
            let requestState = ProtoHelper_5.ProtoCreator.Q_GC2BS_RequestSnapshot();
            requestState.frame = 0;
            Connector_4.Connector.SendToBS(protos_8.Protos.GC2BS_RequestSnapshot, requestState, msg => {
            });
        }
    }
    exports.BattleManager = BattleManager;
});
define("Scene/BattleState", ["require", "exports", "Scene/SceneState", "UI/UIManager", "Model/BattleManager"], function (require, exports, SceneState_5, UIManager_4, BattleManager_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class BattleState extends SceneState_5.SceneState {
        constructor(type) {
            super(type);
            this.__ui = this._ui = UIManager_4.UIManager.battle;
...
define("Scene/SceneManager", ["require", "exports", "RC/FSM/FSM", "Scene/MainState", "Scene/LoginState", "Scene/GlobalState", "Scene/MatchingState", "Scene/BattleState"], function (require, exports, FSM_1, MainState_1, LoginState_1, GlobalState_1, MatchingState_1, BattleState_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var State;
    (function (State) {
...
define("UI/UILogin", ["require", "exports", "../Libs/protos", "UI/UIAlert", "Scene/SceneManager"], function (require, exports, protos_9, UIAlert_3, SceneManager_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class UILogin extends fairygui.Window {
        ...
        OnRegBtnClick() {
            ...
            this.showModalWait();
            SceneManager_7.SceneManager.login.RequestRegister(regName, 0, 0);
        }
        OnLoginBtnClick() {
            ...
            this.showModalWait();
            SceneManager_7.SceneManager.login.RequestLogin(uname, 0, 0);
        }
        OnEnterBtnClick() {
        ...
        OnRegisterResult(resp) {
            this.closeModalWait();
            switch (resp.result) {
                case protos_9.Protos.LS2GC_AskRegRet.EResult.Success:
                    ...
                    break;
                case protos_9.Protos.LS2GC_AskRegRet.EResult.Failed:
                    UIAlert_3.UIAlert.Show("注册失败", this.BackToRegister.bind(this));
                    break;
                case protos_9.Protos.LS2GC_AskRegRet.EResult.UnameExists:
                    UIAlert_3.UIAlert.Show("用户名已存在", this.BackToRegister.bind(this));
                    break;
                case protos_9.Protos.LS2GC_AskRegRet.EResult.UnameIllegal:
                    UIAlert_3.UIAlert.Show("无效的用户名", this.BackToRegister.bind(this));
                    break;
                case protos_9.Protos.LS2GC_AskRegRet.EResult.PwdIllegal:
        ...
        OnLoginResut(resp) {
            this.closeModalWait();
            switch (resp.result) {
                case protos_9.Protos.LS2GC_AskLoginRet.EResult.Success:
                    this.HandleLoginLSSuccess(resp);
                    break;
                case protos_9.Protos.LS2GC_AskLoginRet.EResult.Failed:
                    UIAlert_3.UIAlert.Show("登陆失败", this.BackToLogin.bind(this));
                    break;
                case protos_9.Protos.LS2GC_AskLoginRet.EResult.InvalidUname:
                    UIAlert_3.UIAlert.Show("请输入正确的用户名", this.BackToLogin.bind(this));
                    break;
                case protos_9.Protos.LS2GC_AskLoginRet.EResult.InvalidPwd:
        ...
        OnLoginGSResult(resp) {
            this.closeModalWait();
            switch (resp.result) {
                case protos_9.Protos.GS2GC_LoginRet.EResult.SessionExpire:
...
define("UI/UIManager", ["require", "exports", "UI/UILogin", "UI/UIMain", "UI/UIMatching", "UI/UIBattle"], function (require, exports, UILogin_1, UIMain_1, UIMatching_1, UIBattle_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class UIManager {
...
define("Preloader", ["require", "exports", "RC/Utils/Logger", "Defs"], function (require, exports, Logger_6, Defs_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Preloader {
        static get complete() { return this._complete; }
        static Load(completeHandler) {
            Logger_6.Logger.Log("loading defs...");
        ...
        static LoadUIRes(completeHandler) {
            Logger_6.Logger.Log("loading res...");
...
define("Main", ["require", "exports", "UI/UIManager", "Scene/SceneManager", "Net/Connector", "Net/ProtoHelper", "RC/Utils/Logger", "Preloader", "./Libs/protobufjs", "./Libs/long", "Graphic"], function (require, exports, UIManager_5, SceneManager_8, Connector_5, ProtoHelper_6, Logger_7, Preloader_1, $protobuf, Long, Graphic_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Main {
        ...
        StartGame() {
            ...
            ProtoHelper_6.ProtoCreator.Init();
            Connector_5.Connector.Init();
            Graphic_6.Graphic.Init();
            UIManager_5.UIManager.Init();
            SceneManager_8.SceneManager.Init();
            SceneManager_8.SceneManager.ChangeState(SceneManager_8.SceneManager.State.Login);
            fairygui.GRoot.inst.on(fairygui.Events.SIZE_CHANGED, this, this.OnResize);
            Laya.timer.frameLoop(1, this, this.Update);
        }
        Update() {
            let dt = Laya.timer.delta;
            Connector_5.Connector.Update(dt);
            SceneManager_8.SceneManager.Update(dt);
        }
        OnResize(e) {
            UIManager_5.UIManager.OnResize(e);
        }
    }
    exports.Main = Main;
});
