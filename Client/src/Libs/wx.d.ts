...
interface _createUserInfoButtonObject {
	type: string,
	text: string,
	image: string,
	style: {
...
interface _userInfoButton {
	...
	hide();
	destroy();
	onTap(callback: (resp: _userInfoButtonOnTapCallback) => void);
	offTap(callback: () => void);
}

interface _userInfoButtonOnTapCallback {
	userInfo: _userInfo;
	rawData: string;
	signature: string;
	encryptedData: string;
...
declare namespace wx {
	...
	export function createUserInfoButton(object: _createUserInfoButtonObject): _userInfoButton;
