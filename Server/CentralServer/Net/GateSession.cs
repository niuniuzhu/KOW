...
namespace CentralServer.Net
{
	public class GateSession : SrvCliSession
	{
		protected GateSession( uint id, ProtoType type, X509Certificate2 certificate ) : base( id, type, certificate )
		{
			...
			this.RegMsgHandler( Protos.MsgID.EGc2CsCreateRoom, CS.instance.bizProcessor.OnGc2CsCreateRoom );
			this.RegMsgHandler( Protos.MsgID.EGc2CsLeaveRoom, CS.instance.bizProcessor.OnGc2CsLeaveRoom );
			this.RegMsgHandler( Protos.MsgID.EGc2CsJoinRoom, CS.instance.bizProcessor.OnGc2CsJoinRoom );
