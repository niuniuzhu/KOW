...
namespace Core.Crypto
{
	...
	public class CRC32 : HashAlgorithm
	{
		...
		{
			this._currentCrc = AppendInternal( this._currentCrc, input, offset, length );
		}
		...
		protected override byte[] HashFinal()
		{
			if ( this._isBigEndian )
				return new[] { ( byte )( this._currentCrc >> 24 ), ( byte )( this._currentCrc >> 16 ), ( byte )( this._currentCrc >> 8 ), ( byte )this._currentCrc };
			else
				return new[] { ( byte )this._currentCrc, ( byte )( this._currentCrc >> 8 ), ( byte )( this._currentCrc >> 16 ), ( byte )( this._currentCrc >> 24 ) };
		}
