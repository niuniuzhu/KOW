    ...
    public class GateServerGSWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					GateServer.GS __cl_gen_ret = new GateServer.GS();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GateServer.GS constructor!");
        ...
        static int _m_Initialize(RealStatePtr L)
        {
		    try {
                ...
                {
                    GateServer.Options opts = (GateServer.Options)translator.GetObject(L, 2, typeof(GateServer.Options));
        ...
        static int _g_get_instance(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, GateServer.GS.instance);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_state(RealStatePtr L)
        {
		    try {
                ...
                GateServer.GS __cl_gen_to_be_invoked = (GateServer.GS)translator.FastGetCSObj(L, 1);
                GateServer.GSConfig.State __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
