...
export const Protos = $root.Protos = (() => {
    ...
    Protos.MsgID = (function() {
        ...
        values[valuesById[5303] = "eCS2GC_MatchState"] = 5303;
        values[valuesById[5304] = "eCS2GC_AddToMatch"] = 5304;
        values[valuesById[5305] = "eCS2GC_RemoveFromMatch"] = 5305;
    ...
    Protos.CS2BS_PlayerInfo = (function() {
        ...
        CS2BS_PlayerInfo.prototype.rank = 0;
        CS2BS_PlayerInfo.prototype.exp = 0;
        ...
        CS2BS_PlayerInfo.encode = function encode(message, writer) {
            ...
            if (message.money != null && message.hasOwnProperty("money"))
                writer.uint32(56).int32(message.money);
            if (message.diamoned != null && message.hasOwnProperty("diamoned"))
                writer.uint32(64).int32(message.diamoned);
            if (message.rank != null && message.hasOwnProperty("rank"))
                writer.uint32(72).int32(message.rank);
            if (message.exp != null && message.hasOwnProperty("exp"))
                writer.uint32(80).uint32(message.exp);
            return writer;
        };
    ...
    Protos.CS2DB_Gain = (function() {

        function CS2DB_Gain(properties) {
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        CS2DB_Gain.prototype.ukey = 0;
        CS2DB_Gain.prototype.money = 0;
        CS2DB_Gain.prototype.diamoned = 0;
        CS2DB_Gain.prototype.rank = 0;
        CS2DB_Gain.prototype.exp = 0;

        CS2DB_Gain.create = function create(properties) {
            return new CS2DB_Gain(properties);
        };

        CS2DB_Gain.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            ...
            if (message.diamoned != null && message.hasOwnProperty("diamoned"))
                writer.uint32(24).int32(message.diamoned);
            if (message.rank != null && message.hasOwnProperty("rank"))
                writer.uint32(32).int32(message.rank);
            if (message.exp != null && message.hasOwnProperty("exp"))
                writer.uint32(40).uint32(message.exp);
            return writer;
        };

        CS2DB_Gain.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        CS2DB_Gain.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Protos.CS2DB_Gain();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        CS2DB_Gain.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };

        CS2DB_Gain.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.ukey != null && message.hasOwnProperty("ukey"))
        ...
        CS2DB_Gain.fromObject = function fromObject(object) {
            if (object instanceof $root.Protos.CS2DB_Gain)
                return object;
            let message = new $root.Protos.CS2DB_Gain();
            if (object.ukey != null)
        ...
        CS2DB_Gain.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (options.defaults) {
        ...
        CS2DB_Gain.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    Protos.CS2DB_UpdateRank = (function() {
        ...
        CS2DB_UpdateRank.prototype.gains = $util.emptyArray;
        ...
        CS2DB_UpdateRank.encode = function encode(message, writer) {
            ...
            if (message.opts != null && message.hasOwnProperty("opts"))
                $root.Protos.MsgOpts.encode(message.opts, writer.uint32(10).fork()).ldelim();
            if (message.gains != null && message.gains.length)
                for (let i = 0; i < message.gains.length; ++i)
                    $root.Protos.CS2DB_Gain.encode(message.gains[i], writer.uint32(18).fork()).ldelim();
            return writer;
        };
        ...
        CS2DB_UpdateRank.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    if (!(message.gains && message.gains.length))
                        message.gains = [];
                    message.gains.push($root.Protos.CS2DB_Gain.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        CS2DB_UpdateRank.verify = function verify(message) {
            ...
            if (message.gains != null && message.hasOwnProperty("gains")) {
                if (!Array.isArray(message.gains))
                    return "gains: array expected";
                for (let i = 0; i < message.gains.length; ++i) {
                    let error = $root.Protos.CS2DB_Gain.verify(message.gains[i]);
                    if (error)
                        return "gains." + error;
                }
            }
        ...
        CS2DB_UpdateRank.fromObject = function fromObject(object) {
            ...
            if (object.gains) {
                if (!Array.isArray(object.gains))
                    throw TypeError(".Protos.CS2DB_UpdateRank.gains: array expected");
                message.gains = [];
                for (let i = 0; i < object.gains.length; ++i) {
                    if (typeof object.gains[i] !== "object")
                        throw TypeError(".Protos.CS2DB_UpdateRank.gains: object expected");
                    message.gains[i] = $root.Protos.CS2DB_Gain.fromObject(object.gains[i]);
                }
            }
            return message;
        };
        ...
        CS2DB_UpdateRank.toObject = function toObject(message, options) {
            ...
            if (message.gains && message.gains.length) {
                object.gains = [];
                for (let j = 0; j < message.gains.length; ++j)
                    object.gains[j] = $root.Protos.CS2DB_Gain.toObject(message.gains[j], options);
            }
            return object;
        };
    ...
    Protos.CS2GC_BeginMatchRet = (function() {
        ...
        CS2GC_BeginMatchRet.EResult = (function() {
            ...
            values[valuesById[0] = "Success"] = 0;
            values[valuesById[1] = "Failed"] = 1;
            values[valuesById[2] = "UserInBattle"] = 2;
            return values;
        })();
    ...
    Protos.CS2GC_PlayerInfo = (function() {
        ...
        CS2GC_PlayerInfo.prototype.vaild = false;
        ...
        CS2GC_PlayerInfo.prototype.money = 0;
        CS2GC_PlayerInfo.prototype.diamoned = 0;
        CS2GC_PlayerInfo.prototype.rank = 0;
        CS2GC_PlayerInfo.prototype.exp = 0;
        ...
        CS2GC_PlayerInfo.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.vaild != null && message.hasOwnProperty("vaild"))
                writer.uint32(8).bool(message.vaild);
            if (message.gcNID != null && message.hasOwnProperty("gcNID"))
                writer.uint32(16).uint64(message.gcNID);
            if (message.actorID != null && message.hasOwnProperty("actorID"))
            ...
            if (message.money != null && message.hasOwnProperty("money"))
                writer.uint32(64).int32(message.money);
            if (message.diamoned != null && message.hasOwnProperty("diamoned"))
                writer.uint32(72).int32(message.diamoned);
            if (message.rank != null && message.hasOwnProperty("rank"))
                writer.uint32(80).int32(message.rank);
            if (message.exp != null && message.hasOwnProperty("exp"))
                writer.uint32(88).uint32(message.exp);
            return writer;
        };
        ...
        CS2GC_PlayerInfo.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.vaild != null && message.hasOwnProperty("vaild"))
                if (typeof message.vaild !== "boolean")
                    return "vaild: boolean expected";
            if (message.gcNID != null && message.hasOwnProperty("gcNID"))
                if (!$util.isInteger(message.gcNID) && !(message.gcNID && $util.isInteger(message.gcNID.low) && $util.isInteger(message.gcNID.high)))
                    return "gcNID: integer|Long expected";
            if (message.actorID != null && message.hasOwnProperty("actorID"))
        ...
        CS2GC_PlayerInfo.fromObject = function fromObject(object) {
            ...
            if (object.vaild != null)
                message.vaild = Boolean(object.vaild);
            if (object.gcNID != null)
                if ($util.Long)
                    (message.gcNID = $util.Long.fromValue(object.gcNID)).unsigned = true;
                else if (typeof object.gcNID === "string")
    ...
    Protos.CS2GC_MatchState = (function() {

        function CS2GC_MatchState(properties) {
            this.playerInfos = [];
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        CS2GC_MatchState.prototype.opts = null;
        CS2GC_MatchState.prototype.playerInfos = $util.emptyArray;

        CS2GC_MatchState.create = function create(properties) {
            return new CS2GC_MatchState(properties);
        };

        CS2GC_MatchState.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.opts != null && message.hasOwnProperty("opts"))
                $root.Protos.MsgOpts.encode(message.opts, writer.uint32(10).fork()).ldelim();
        ...
        CS2GC_MatchState.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        CS2GC_MatchState.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Protos.CS2GC_MatchState();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        CS2GC_MatchState.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };

        CS2GC_MatchState.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.opts != null && message.hasOwnProperty("opts")) {
                let error = $root.Protos.MsgOpts.verify(message.opts);
        ...
        CS2GC_MatchState.fromObject = function fromObject(object) {
            if (object instanceof $root.Protos.CS2GC_MatchState)
                return object;
            let message = new $root.Protos.CS2GC_MatchState();
            if (object.opts != null) {
                if (typeof object.opts !== "object")
                    throw TypeError(".Protos.CS2GC_MatchState.opts: object expected");
                message.opts = $root.Protos.MsgOpts.fromObject(object.opts);
            }
            if (object.playerInfos) {
                if (!Array.isArray(object.playerInfos))
                    throw TypeError(".Protos.CS2GC_MatchState.playerInfos: array expected");
                message.playerInfos = [];
                for (let i = 0; i < object.playerInfos.length; ++i) {
                    if (typeof object.playerInfos[i] !== "object")
                        throw TypeError(".Protos.CS2GC_MatchState.playerInfos: object expected");
        ...
        CS2GC_MatchState.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (options.arrays || options.defaults)
        ...
        CS2GC_MatchState.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return CS2GC_MatchState;
    })();

    Protos.CS2GC_AddToMatch = (function() {

        function CS2GC_AddToMatch(properties) {
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        CS2GC_AddToMatch.prototype.opts = null;

        CS2GC_AddToMatch.create = function create(properties) {
            return new CS2GC_AddToMatch(properties);
        };

        CS2GC_AddToMatch.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.opts != null && message.hasOwnProperty("opts"))
                $root.Protos.MsgOpts.encode(message.opts, writer.uint32(10).fork()).ldelim();
        ...
        CS2GC_AddToMatch.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        CS2GC_AddToMatch.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Protos.CS2GC_AddToMatch();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        CS2GC_AddToMatch.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };

        CS2GC_AddToMatch.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.opts != null && message.hasOwnProperty("opts")) {
                let error = $root.Protos.MsgOpts.verify(message.opts);
        ...
        CS2GC_AddToMatch.fromObject = function fromObject(object) {
            if (object instanceof $root.Protos.CS2GC_AddToMatch)
                return object;
            let message = new $root.Protos.CS2GC_AddToMatch();
            if (object.opts != null) {
                if (typeof object.opts !== "object")
                    throw TypeError(".Protos.CS2GC_AddToMatch.opts: object expected");
                message.opts = $root.Protos.MsgOpts.fromObject(object.opts);
            }
            return message;
        };

        CS2GC_AddToMatch.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (options.defaults)
        ...
        CS2GC_AddToMatch.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return CS2GC_AddToMatch;
    })();

    Protos.CS2GC_RemoveFromMatch = (function() {

        function CS2GC_RemoveFromMatch(properties) {
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        CS2GC_RemoveFromMatch.prototype.opts = null;

        CS2GC_RemoveFromMatch.create = function create(properties) {
            return new CS2GC_RemoveFromMatch(properties);
        };

        CS2GC_RemoveFromMatch.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.opts != null && message.hasOwnProperty("opts"))
                $root.Protos.MsgOpts.encode(message.opts, writer.uint32(10).fork()).ldelim();
        ...
        CS2GC_RemoveFromMatch.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        CS2GC_RemoveFromMatch.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Protos.CS2GC_RemoveFromMatch();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        CS2GC_RemoveFromMatch.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };

        CS2GC_RemoveFromMatch.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.opts != null && message.hasOwnProperty("opts")) {
                let error = $root.Protos.MsgOpts.verify(message.opts);
        ...
        CS2GC_RemoveFromMatch.fromObject = function fromObject(object) {
            if (object instanceof $root.Protos.CS2GC_RemoveFromMatch)
                return object;
            let message = new $root.Protos.CS2GC_RemoveFromMatch();
            if (object.opts != null) {
                if (typeof object.opts !== "object")
                    throw TypeError(".Protos.CS2GC_RemoveFromMatch.opts: object expected");
                message.opts = $root.Protos.MsgOpts.fromObject(object.opts);
            }
            return message;
        };

        CS2GC_RemoveFromMatch.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (options.defaults)
        ...
        CS2GC_RemoveFromMatch.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        return CS2GC_RemoveFromMatch;
    })();
    ...
    Protos.CS2GC_BattleEnd = (function() {
        ...
        CS2GC_BattleEnd.prototype.gRank = 0;
        CS2GC_BattleEnd.prototype.gMoney = 0;
        CS2GC_BattleEnd.prototype.gDiamoned = 0;
        CS2GC_BattleEnd.prototype.gExp = 0;
        CS2GC_BattleEnd.prototype.rank = 0;
        CS2GC_BattleEnd.prototype.money = 0;
        CS2GC_BattleEnd.prototype.diamoned = 0;
        CS2GC_BattleEnd.prototype.exp = 0;
        ...
        CS2GC_BattleEnd.encode = function encode(message, writer) {
            ...
            if (message.result != null && message.hasOwnProperty("result"))
                writer.uint32(16).int32(message.result);
            if (message.gRank != null && message.hasOwnProperty("gRank"))
                writer.uint32(24).int32(message.gRank);
            if (message.gMoney != null && message.hasOwnProperty("gMoney"))
                writer.uint32(32).int32(message.gMoney);
            if (message.gDiamoned != null && message.hasOwnProperty("gDiamoned"))
                writer.uint32(40).int32(message.gDiamoned);
            if (message.gExp != null && message.hasOwnProperty("gExp"))
                writer.uint32(48).uint32(message.gExp);
            if (message.rank != null && message.hasOwnProperty("rank"))
        ...
        CS2GC_BattleEnd.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.gRank = reader.int32();
                    break;
                case 4:
                    message.gMoney = reader.int32();
                    break;
                case 5:
                    message.gDiamoned = reader.int32();
                    break;
                case 6:
                    message.gExp = reader.uint32();
                    break;
                case 7:
                    message.rank = reader.int32();
                    break;
        ...
        CS2GC_BattleEnd.verify = function verify(message) {
            ...
            if (message.gRank != null && message.hasOwnProperty("gRank"))
                if (!$util.isInteger(message.gRank))
                    return "gRank: integer expected";
            if (message.gMoney != null && message.hasOwnProperty("gMoney"))
                if (!$util.isInteger(message.gMoney))
                    return "gMoney: integer expected";
            if (message.gDiamoned != null && message.hasOwnProperty("gDiamoned"))
                if (!$util.isInteger(message.gDiamoned))
                    return "gDiamoned: integer expected";
            if (message.gExp != null && message.hasOwnProperty("gExp"))
                if (!$util.isInteger(message.gExp))
                    return "gExp: integer expected";
            if (message.rank != null && message.hasOwnProperty("rank"))
                if (!$util.isInteger(message.rank))
                    return "rank: integer expected";
            if (message.money != null && message.hasOwnProperty("money"))
        ...
        CS2GC_BattleEnd.fromObject = function fromObject(object) {
            ...
            if (object.gRank != null)
                message.gRank = object.gRank | 0;
            if (object.gMoney != null)
                message.gMoney = object.gMoney | 0;
            if (object.gDiamoned != null)
                message.gDiamoned = object.gDiamoned | 0;
            if (object.gExp != null)
                message.gExp = object.gExp >>> 0;
            if (object.rank != null)
                message.rank = object.rank | 0;
            if (object.money != null)
                message.money = object.money | 0;
        ...
        CS2GC_BattleEnd.toObject = function toObject(message, options) {
            ...
            if (message.gRank != null && message.hasOwnProperty("gRank"))
                object.gRank = message.gRank;
            if (message.gMoney != null && message.hasOwnProperty("gMoney"))
                object.gMoney = message.gMoney;
            if (message.gDiamoned != null && message.hasOwnProperty("gDiamoned"))
                object.gDiamoned = message.gDiamoned;
            if (message.gExp != null && message.hasOwnProperty("gExp"))
                object.gExp = message.gExp;
            if (message.rank != null && message.hasOwnProperty("rank"))
                object.rank = message.rank;
            if (message.money != null && message.hasOwnProperty("money"))
                object.money = message.money;
    ...
    Protos.GC2CS_CancelMatch = (function() {

        function GC2CS_CancelMatch(properties) {
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        GC2CS_CancelMatch.prototype.opts = null;

        GC2CS_CancelMatch.create = function create(properties) {
            return new GC2CS_CancelMatch(properties);
        };

        GC2CS_CancelMatch.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.opts != null && message.hasOwnProperty("opts"))
                $root.Protos.MsgOpts.encode(message.opts, writer.uint32(10).fork()).ldelim();
        ...
        GC2CS_CancelMatch.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        GC2CS_CancelMatch.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Protos.GC2CS_CancelMatch();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        GC2CS_CancelMatch.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };

        GC2CS_CancelMatch.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.opts != null && message.hasOwnProperty("opts")) {
                let error = $root.Protos.MsgOpts.verify(message.opts);
        ...
        GC2CS_CancelMatch.fromObject = function fromObject(object) {
            if (object instanceof $root.Protos.GC2CS_CancelMatch)
                return object;
            let message = new $root.Protos.GC2CS_CancelMatch();
            if (object.opts != null) {
                if (typeof object.opts !== "object")
                    throw TypeError(".Protos.GC2CS_CancelMatch.opts: object expected");
                message.opts = $root.Protos.MsgOpts.fromObject(object.opts);
            }
            return message;
        };

        GC2CS_CancelMatch.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (options.defaults)
        ...
        GC2CS_CancelMatch.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
