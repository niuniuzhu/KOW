...
ProtoCreator._TYPE2ID = new Map([
    [Protos.G_AskPing, 10],
    [Protos.G_AskPingRet, 11],
    [Protos.GC2LS_AskRegister, 1000],
    [Protos.GC2LS_AskLogin, 1001],
    [Protos.GC2LS_AskSmartLogin, 1002],
    [Protos.GC2GS_AskLogin, 1100],
    [Protos.GC2GS_KeepAlive, 1101],
    [Protos.GC2BS_AskLogin, 1200],
    [Protos.GC2BS_KeepAlive, 1201],
    [Protos.GC2CS_BeginMatch, 1300],
    [Protos.GC2CS_UpdatePlayerInfo, 1301],
    [Protos.LS2GC_GSInfo, 2000],
    [Protos.LS2GC_AskRegRet, 2001],
    [Protos.LS2GC_AskLoginRet, 2002],
    [Protos.LS2CS_GCLogin, 2100],
    [Protos.LS2DB_QueryAccount, 2200],
    [Protos.LS2DB_QueryLogin, 2201],
    [Protos.LS2DB_Exec, 2202],
    [Protos.GS2CS_ReportState, 3000],
    [Protos.GS2CS_GCAskLogin, 3001],
    [Protos.GS2CS_GCLost, 3002],
    [Protos.GS2CS_KickGCRet, 3003],
    [Protos.GS2GC_LoginRet, 3100],
    [Protos.GS2GC_Kick, 3101],
    [Protos.BS2CS_ReportState, 4000],
    [Protos.BS2CS_BattleInfoRet, 4001],
    [Protos.BS2CS_BattleStart, 4002],
    [Protos.BS2CS_BattleEnd, 4003],
    [Protos.BS2GC_LoginRet, 4100],
    [Protos.BS2GC_BattleStart, 4102],
    [Protos.BS2GC_BattleEnd, 4103],
    [Protos.CS2LS_GSInfos, 5000],
    [Protos.CS2LS_GSInfo, 5001],
    [Protos.CS2LS_GSLost, 5002],
    [Protos.CS2LS_GCLoginRet, 5003],
    [Protos.CS2GS_GCLoginRet, 5100],
    [Protos.CS2GS_KickGC, 5101],
    [Protos.CS2BS_BattleInfo, 5200],
    [Protos.CS2BS_BattleStartRet, 5201],
    [Protos.CS2BS_BattleEndRet, 5202],
    [Protos.CS2GC_BeginMatchRet, 5300],
    [Protos.CS2GC_PlayerJoin, 5301],
    [Protos.CS2GC_PlayerLeave, 5302],
    [Protos.CS2GC_RoomInfo, 5303],
    [Protos.CS2GC_EnterBattle, 5304],
    [Protos.DB2LS_QueryAccountRet, 8000],
    [Protos.DB2LS_QueryLoginRet, 8001],
    [Protos.DB2LS_ExecRet, 8002],
]);
ProtoCreator._ID2TYPE = new Map([
    [10, Protos.G_AskPing],
    [11, Protos.G_AskPingRet],
    [1000, Protos.GC2LS_AskRegister],
    [1001, Protos.GC2LS_AskLogin],
    [1002, Protos.GC2LS_AskSmartLogin],
    [1100, Protos.GC2GS_AskLogin],
    [1101, Protos.GC2GS_KeepAlive],
    [1200, Protos.GC2BS_AskLogin],
    [1201, Protos.GC2BS_KeepAlive],
    [1300, Protos.GC2CS_BeginMatch],
    [1301, Protos.GC2CS_UpdatePlayerInfo],
    [2000, Protos.LS2GC_GSInfo],
    [2001, Protos.LS2GC_AskRegRet],
    [2002, Protos.LS2GC_AskLoginRet],
    [2100, Protos.LS2CS_GCLogin],
    [2200, Protos.LS2DB_QueryAccount],
    [2201, Protos.LS2DB_QueryLogin],
    [2202, Protos.LS2DB_Exec],
    [3000, Protos.GS2CS_ReportState],
    [3001, Protos.GS2CS_GCAskLogin],
    [3002, Protos.GS2CS_GCLost],
    [3003, Protos.GS2CS_KickGCRet],
    [3100, Protos.GS2GC_LoginRet],
    [3101, Protos.GS2GC_Kick],
    [4000, Protos.BS2CS_ReportState],
    [4001, Protos.BS2CS_BattleInfoRet],
    [4002, Protos.BS2CS_BattleStart],
    [4003, Protos.BS2CS_BattleEnd],
    [4100, Protos.BS2GC_LoginRet],
    [4102, Protos.BS2GC_BattleStart],
    [4103, Protos.BS2GC_BattleEnd],
    [5000, Protos.CS2LS_GSInfos],
    [5001, Protos.CS2LS_GSInfo],
    [5002, Protos.CS2LS_GSLost],
    [5003, Protos.CS2LS_GCLoginRet],
    [5100, Protos.CS2GS_GCLoginRet],
    [5101, Protos.CS2GS_KickGC],
    [5200, Protos.CS2BS_BattleInfo],
    [5201, Protos.CS2BS_BattleStartRet],
    [5202, Protos.CS2BS_BattleEndRet],
    [5300, Protos.CS2GC_BeginMatchRet],
    [5301, Protos.CS2GC_PlayerJoin],
    [5302, Protos.CS2GC_PlayerLeave],
    [5303, Protos.CS2GC_RoomInfo],
    [5304, Protos.CS2GC_EnterBattle],
    [8000, Protos.DB2LS_QueryAccountRet],
    [8001, Protos.DB2LS_QueryLoginRet],
    [8002, Protos.DB2LS_ExecRet],
]);
